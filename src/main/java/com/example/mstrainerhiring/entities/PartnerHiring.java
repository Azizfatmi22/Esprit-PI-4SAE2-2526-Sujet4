...
public class PartnerHiring {
    ...
    @Pattern(regexp = "^[2579][0-9]{7}$", message = "Phone must be a valid Tunisian number (8 digits starting with 2, 5, 7, or 9)")
    @Column(name = "phone", nullable = false)
    private String phone;

    @NotBlank(message = "Website is required")
    @Pattern(regexp = "^https?://.*", message = "Website must be a valid URL (http or https)")
